					...
					<div class="tg-userlogin">
						...
						<!-- <figure> -->
							<a href="javascript:void(0);"><img
								src="<%=SecurityUtils.getPrincipal().getImages()%>" alt="image description"></a>
					<!-- 	</figure> -->
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<strong class="tg-logo"><a href="index-2.html"><img
							src="images/logo.png" alt="company name here"></a></strong>
								...
								<div class="tg-minicartbody">
									<div class="tg-minicarproduct">
										...
										<div class="tg-minicarproductdata">
											<h5>
												<a href="javascript:void(0);">Our State Fair Is A Great
													Function</a>
											</h5>
											<h6>
						...
						<div id="tg-navigation"
							...
							<ul>
									...
									<div class="mega-menu">
										<ul class="tg-themetabnav" role="tablist">
											<li role="presentation" class="active"><a
												href="#artandphotography" aria-controls="artandphotography"
												role="tab" data-toggle="tab">Art &amp; Photography</a></li>
											...
											<li role="presentation"><a href="#craftandhobbies"
												aria-controls="craftandhobbies" role="tab" data-toggle="tab">Craft
													&amp; Hobbies</a></li>
											...
											<li role="presentation"><a href="#sciencefiction"
												aria-controls="sciencefiction" role="tab" data-toggle="tab">Science
													Fiction</a></li>
										</ul>
								...
								<li class="menu-item-has-children current-menu-item"><a
									...
									<ul class="sub-menu">
										<li class="menu-item-has-children"><a href="aboutus.html">Products</a>
											<ul class="sub-menu">
