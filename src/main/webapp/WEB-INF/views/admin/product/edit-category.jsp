...
<c:url var="productURL" value="/quan-tri/danh-muc/danh-sach" />
<c:url var="editproductURL" value="/quan-tri/danh-muc/chinh-sua" />
					...
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="danh-sach">Static Navigation</a> <a
				...
				<form:form class="tm-edit-product-form" role="form" id="formSubmit"
					...
					<div class="container-fluid px-4">
						...
						<ol class="breadcrumb mb-4">
							<li class="breadcrumb-item active">Detail List-Category</li>
						</ol>
										...
										<div class="row tm-edit-product-row">
											<div class="col-xl-6 col-lg-6 col-md-12">
												...
												<div class="form-group mb-3">
													...
													<form:textarea name="status" path="status"
